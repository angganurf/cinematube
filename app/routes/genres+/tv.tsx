...
export const meta = mergeMeta(() => [
  { title: 'Cinematube Tv shows - Genres' },
  { name: 'description', content: 'Tv shows Genres' },
  { property: 'og:url', content: 'https://cinematube.vercel.app/genres/tv' },
  { property: 'og:title', content: 'Cinematube Tv shows - Genres' },
  ...
  { name: 'twitter:title', content: 'Cinematube Tv shows - Genres' },
